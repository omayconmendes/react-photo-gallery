...
export const inputSingleFileVariants = tv({
    base: `
        flex flex-col items-center justify-center w-full border border-solid border-border-primary
                ...
                <>
                    ...
                    <div className={"flex flex-col gap-1 mt-1"}>
                        ...
                        {formFile && !isValidSize() &&
                            <Text variant={"label-small"} className={"text-accent-red"}>O tamanho do arquivo ultrapassa o tamanho máximo.</Text>
                        }
